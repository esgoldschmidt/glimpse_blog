                    ...
                    <div className="card-grid-responsive text-center gap-4 flex flex-wrap justify-center w-11/12 lg:w-3/4">
                        <div className='flex flex-col'>
                            <div className="card_flip">
                                <div className="card__content_flip">
                                    <div 
                                        className="card__front_flip"  
                                        style={{
                            ...
                            <h3 className="pb-clr mt-2">Lyron Bentovim</h3>
                            <h4>PRESIDENT & CEO</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Maydan Rothblum</h3>
                            <h4>CFO & COO</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">DJ Smith</h3>
                            <h4>CCO</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Jeff Meisner</h3>
                            <h4>CRO</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">James Watson</h3>
                            <h4>CMO</h4>
                        </div>
                ...
                <div className='flex justify-center'>
                    <div className="card-grid-responsive text-center gap-4 flex flex-wrap justify-center w-11/12 lg:w-3/4">
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Sharon Rowlands</h3>
                            <h4>BOARD MEMBER</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Jeff Enslin</h3>
                            <h4>BOARD MEMBER</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Lemuel Amen</h3>
                            <h4>BOARD MEMBER</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Alexander Ruckdaeschel</h3>
                            <h4>BOARD MEMBER</h4>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <h3 className="pb-clr mt-2">Ian Charles</h3>
                            <h4>BOARD MEMBER</h4>
                        </div>
                    </div>
                </div>
