            ...
            <div className="collapse navbar-collapse w-full" id="navbarSupportedContent">
              <ul className="flex w-full justify-center p-0 text-gray-700">
                <li className={`nav-item ${location.pathname === "/" || location.pathname === "/home" ? "font-medium" : "font-light"} transition duration-500 transform hover:-translate-y-1`} style={{ fontFamily: 'Montserrat' }}>
                  <a className="nav-link py-2.5 pr-2.5 pl-0 text-gray-500 hover:text-sky-600 whitespace-nowrap" href="/">Home</a>
                </li>
                <li className={`nav-item ${location.pathname === "/about-glimpse" ? "font-medium" : "font-light"} transition duration-500 transform hover:-translate-y-1`} style={{ fontFamily: 'Montserrat' }}>
                  <a className="nav-link p-2.5 text-gray-500 hover:text-sky-600 whitespace-nowrap" href="/about-glimpse">About Glimpse</a>
                </li>
                ...
                location.pathname === "/industry-solutions/events-and-meetings" ? "font-medium" : "font-light"} transition duration-500 transform hover:-translate-y-1`} style={{ fontFamily: 'Montserrat' }}>
                  <a className="nav-link p-2.5 dropdown-toggle text-gray-500 hover:text-sky-600 whitespace-nowrap" id="solutions" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Industry Solutions
                  </a>
                  <div className="dropdown-menu" aria-labelledby="solutions" style={{ width: '200px' }}>
                    {/* <div className="dropdown-divider"></div> */}
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/architecture-engineering-construction" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/architecture-engineering-construction">AEC</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/k12-education" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/k12-education">K-12 Education</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/higher-education" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/higher-education">Higher Education</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/food-hospitality" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/food-hospitality">Food & Hospitality</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/professional-training" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/professional-training">Professional Training</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/finance-data-visualization" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/finance-data-visualization">Data Visualization</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/healthcare" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/healthcare">Healthcare</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/marketing" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/marketing">Marketing</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/industry-solutions/events-and-meetings" ? "bg-glimpse-blue text-white" : ""}`} href="/industry-solutions/events-and-meetings">Events & Meetings</a>
                  </div>
                </li>
                <li className={`nav-item dropdown ${location.pathname === "/news/press-releases" || location.pathname === "/news/glimpse-blog" || location.pathname === "/news/press-coverage" ? "font-medium" : "font-light"} transition duration-500 transform hover:-translate-y-1`} style={{ fontFamily: 'Montserrat' }}>
                  <a className="nav-link p-2.5 dropdown-toggle text-gray-500 hover:text-sky-600 whitespace-nowrap" href="#" id="news" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    News
                  </a>
                  <div className="dropdown-menu" aria-labelledby="news">
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/news/press-releases" ? "bg-glimpse-blue text-white" : ""}`} href="/news/press-releases">Press Releases</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/news/glimpse-blog" ? "bg-glimpse-blue text-white" : ""}`} href="/news/glimpse-blog">Glimpse Blog</a>
                    <a className={`dropdown-item hover:bg-glimpse-blue hover:text-white text-sm whitespace-nowrap ${location.pathname === "/news/press-coverage" ? "bg-glimpse-blue text-white" : ""}`} href="/news/press-coverage" target="_blank">Press Coverage</a>
                  </div>
                </li>
                <li className={`nav-item ${location.pathname === "/our-work" ? "font-medium" : "font-light"} transition duration-500 transform hover:-translate-y-1`} style={{ fontFamily: 'Montserrat' }}>
                  <a className="nav-link p-2.5 text-gray-500 hover:text-sky-600 whitespace-nowrap" href="/our-work">Our Work</a>
                </li>
                <li className={`nav-item ${location.pathname === "/our-companies" ? "font-medium" : "font-light"} transition duration-500 transform hover:-translate-y-1`} style={{ fontFamily: 'Montserrat' }}>
                  <a className="nav-link p-2.5 text-gray-500 hover:text-sky-600 whitespace-nowrap" href="/our-companies">Our Companies</a>
                </li>
