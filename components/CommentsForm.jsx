...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            <h3 className='text-xl mb-8 font-semibold border-b pb-3'>Leave A Comment</h3>
            ...
            <div className='mt-8'>
                <button 
                    ...
                    className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-orange-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer'
                    >
                    Post Comment
                </button>
